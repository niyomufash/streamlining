...
function Cards() {
  return (
    <div style={{backgroundColor:'#F3F6F9'}} className='p-[4rem]'>
        <div className='flex justify-center'>Ibyuma bya Elektonic</div>
      <div  className='grid gap-2 md:grid-cols-2 p-4'>
        <div className=' card'>
        <div className='pt-3  pb-4 flex justify-center'>
              ...
              <div className='p-7 justify-center flex flex-col items-center text-center'>
                <h2 className='pb-2'> <b>Transfer the ownership</b></h2>
      ...
      {/* style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', padding: '1rem' }} */}
